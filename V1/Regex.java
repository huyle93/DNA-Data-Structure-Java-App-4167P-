...
public class Regex
{
    ...
    private String           _regexString11;    // currently active reg expr
    public String           _inputString22;
    private StringBuilder    _strBuilder33;
    ...
    {  
        ...
        {
            _regexString11 = regex;    
            _pattern = _pattern.compile( _regexString11, _flags );
            makeMatcher();
        }
    ...
    public void makeMatcher(  )
    {
        ...
        //////////////////////////////////////////////////////////////
        System.out.println("making matcher  " + _inputString22 );
        
        if ( _pattern != null && _inputString22 != null )
            _matcher = _pattern.matcher( _inputString22 );
    ...
    public String findAll()
    {
        ...
        else
        {
            ...
            System.out.println( "Findall: _inputString = " + _inputString22 );
            results +=  _inputString22.substring( results.length() );
        }
    ...
    public String split()
    {
        ...
        if( _pattern != null && _inputString22 != null )
        {
            String[] str = _pattern.split( _inputString22 );
