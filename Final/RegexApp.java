...
public class RegexApp
{
    ...
    public void readDNAfile( String dnaFileName )
    {
        ...
        if( dnaFileName != null )
        {
            try
            {
                ...
                //System.out.println( "here" + dnaFileName );
            ...
            {
                System.out.println( "DNAFile IOException " + ioe.getMessage() );
            }
        }
    ...
    public void readDNAfile( File dnaFile )
    {
        ...
        if ( dnaFile != null )
        {
            try 
            {
                ...
                //System.out.println( "here" + dnaFile );
                if ( _dnaIn.hasNextLine() )
                {
                    _seqHeader = _dnaIn.nextLine(); 
                    _display.setInputTitle( _seqHeader ); 
   ...
   //---------------------- nextDNAseq() -----------------------------
    ...
    {  
        //////////////////// 9P code ////////////////////////////////
        String in = "", dispContents = "", contents = ""; 
        ...
        while( moreToRead )
        {
            ...
            {                
                if( _seqHeader != null ) 
                {
                    _display.setInputTitle( _seqHeader ); //set next header
                }
                ...
                if( plainText ) 
                {
                    ...
                    if( _input != null && regex != null )
                    {
                        regex.setInput( _input );
                        System.out.println( "Refreshed plaintext ");
                    }   
                }
                else
                {
                    if( _seqLineLen < 0 ) //displayText on the left side
                    {
                        _seqLineLen = in.length();
                    }
                    dispContents += in + "\n";
                ...
                moreToRead = _dnaIn.hasNextLine();
            }
            System.out.println(" input = " + regex._inputString);
        }
    }
    ...
    {      
        ...
        if( results.length() > 0 )
        {
            ...
            System.out.println( "Can't find any matches! Try Again " );
